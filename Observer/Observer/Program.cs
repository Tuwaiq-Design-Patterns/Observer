    ...
    class Observer
    {
        ...
        public class SubjectCourse : ISubjectCourse
        {
            ...
            public void Logic()
            {
                ...
                Console.WriteLine(" the course has just changed to: " + this.State);
                this.Notify();
            }
        }


        class AlgorithmsObserver : IObserver
        {
        ...
        class LinearAlgebraObserver : IObserver
        {
            public void Update(ISubjectCourse subject)
            {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                var Math = new AlgorithmsObserver();
                subject.Subscribe(Math);
                var chemistry = new LinearAlgebraObserver();
